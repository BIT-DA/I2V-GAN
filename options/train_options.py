...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lam_EXS', type=float, default=0.1, help='temperature for EXS loss')
        self.parser.add_argument('--lam_INS', type=float, default=40.0, help='temperature for INS loss')
