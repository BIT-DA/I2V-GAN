...
#	    self.parser.add_argument('--which_model_netP', type=str, default='unet_256', help='selects model to use for netG')
        self.parser.add_argument('--which_model_netP', type=str, default='unet_256', help='selects model to use for netG')
        ...
        self.parser.add_argument('--display_id', type=int, default=43, help='window id of the web display')
